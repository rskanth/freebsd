...
#define P9PROTO_DOTL_NOACCESS      00000003
#define P9PROTO_DOTL_CREATE        00000100
#define P9PROTO_DOTL_EXCL          00000200
#define P9PROTO_DOTL_NOCTTY        00000400
#define P9PROTO_DOTL_TRUNC         00001000
#define P9PROTO_DOTL_APPEND        00002000
#define P9PROTO_DOTL_NONBLOCK      00004000
#define P9PROTO_DOTL_DSYNC         00010000
#define P9PROTO_DOTL_FASYNC        00020000
#define P9PROTO_DOTL_DIRECT        00040000
#define P9PROTO_DOTL_LARGEFILE     00100000
#define P9PROTO_DOTL_DIRECTORY     00200000
#define P9PROTO_DOTL_NOFOLLOW      00400000
#define P9PROTO_DOTL_NOATIME       01000000
#define P9PROTO_DOTL_CLOEXEC       02000000
#define P9PROTO_DOTL_SYNC          04000000

/* 9p2000.L at flags */
#define P9PROTO_DOTL_AT_REMOVEDIR		0x200

/* 9p2000.L lock type */
#define P9PROTO_LOCK_TYPE_RDLCK 0
#define P9PROTO_LOCK_TYPE_WRLCK 1
#define P9PROTO_LOCK_TYPE_UNLCK 2
